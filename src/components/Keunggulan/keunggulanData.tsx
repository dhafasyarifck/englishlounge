...
const keunggulanData: Feature[] = [
  {
    ...
    paragraph:
      "At English Lounge, we create a vibrant and interactive atmosphere that makes learning enjoyable. Our classes are designed with fun activities, games, and multimedia resources, ensuring that children stay engaged and motivated to learn. This approach helps to foster a love for the English language from an early age.",
  },
  {
    id: 1,
    icon: (
    ...
    paragraph:
      "We understand that every child learns at their own pace. Our curriculum is tailored to meet the diverse needs of each student, ensuring that they receive personalized attention. By incorporating various learning styles and preferences, we aim to provide an effective learning experience that caters to each child's unique abilities and interests.",
  },
  {
    id: 1,
    icon: (
    ...
    title: "Qualified and Passionate Instructors",
    paragraph:
      "Our team of experienced and enthusiastic instructors are dedicated to nurturing young learners. They are not only proficient in English but also skilled in teaching methodologies that work best for children. With a focus on creating a supportive and encouraging atmosphere, our instructors inspire confidence and help students develop their language skills effectively.",
  },
  
];
export default keunggulanData;
